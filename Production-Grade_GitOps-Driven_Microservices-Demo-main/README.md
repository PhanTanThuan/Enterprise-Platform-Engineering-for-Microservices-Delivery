...
# Thuan's GitOps Microservices Demo

This is a type of e-commerce platform built to demonstrate GitOps-driven microservices architecture. It focuses on:
...
>
>This demo app is made up of multiple services like:
>
...
| --- | --- | --- |
| [frontend](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/frontend) | Go | Exposes an HTTP server to serve the website. Does not require signup/login and generates session IDs for all users automatically. |
| [cartservice](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/cartservice) | C# | Stores the items in the user's shopping cart in Redis and retrieves it. |
| [productcatalogservice](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/productcatalogservice) | Go | Provides the list of products from a JSON file and ability to search products and get individual products. |
| [currencyservice](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/currencyservice) | Node.js | Converts one money amount to another currency. Uses real values fetched from European Central Bank. It's the highest QPS service. |
| [paymentservice](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/paymentservice) | Node.js | Charges the given credit card info (mock) with the given amount and returns a transaction ID. |
| [shippingservice](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/shippingservice) | Go | Gives shipping cost estimates based on the shopping cart. Ships items to the given address (mock) |
| [emailservice](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/emailservice) | Python | Sends users an order confirmation email (mock). |
| [checkoutservice](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/checkoutservice) | Go | Retrieves user cart, prepares order and orchestrates the payment, shipping and the email notification. |
| [recommendationservice](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/recommendationservice) | Python | Recommends other products based on what's given in the cart. |
| [adservice](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/adservice) | Java | Provides text ads based on given context words. |
| [loadgenerator](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/loadgenerator) | Python/Locust | Continuously sends requests imitating realistic user shopping flows to the frontend. |
...
```bash
https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo.git
```
...
helmCharts:
  - name: boutique-app
    repo: oci://ghcr.io/your-github-username/onlineboutique
    version: 0.10.4
...
spec:
  ...
  source:
    repoURL: https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo.git
    targetRevision: HEAD
    path: .
...
Normal  Pulled     51m   kubelet            spec.containers{server}: Container image "ghcr.io/your-github-username/microservices-demo/frontend:v0.10.4" already present on machine
```
...
spec:
  ...
  applicationRefs:
    - namePattern: "boutique-*"
      ...
      images:
        - alias: adservice
          imageName: ghcr.io/your-github-username/microservices-demo/adservice

        - alias: cartservice
          imageName: ghcr.io/your-github-username/microservices-demo/cartservice

        - alias: checkoutservice
          imageName: ghcr.io/your-github-username/microservices-demo/checkoutservice

        - alias: currencyservice
          imageName: ghcr.io/your-github-username/microservices-demo/currencyservice

        - alias: emailservice
          imageName: ghcr.io/your-github-username/microservices-demo/emailservice

        - alias: frontend
          imageName: ghcr.io/your-github-username/microservices-demo/frontend

        - alias: paymentservice
          imageName: ghcr.io/your-github-username/microservices-demo/paymentservice

        - alias: productcatalogservice
          imageName: ghcr.io/your-github-username/microservices-demo/productcatalogservice

        - alias: recommendationservice
          imageName: ghcr.io/your-github-username/microservices-demo/recommendationservice

        - alias: shippingservice
          imageName: ghcr.io/your-github-username/microservices-demo/shippingservice

        - alias: loadgenerator
          imageName: ghcr.io/your-github-username/microservices-demo/loadgenerator
```
...
```bash
docker tag us-central1-docker.pkg.dev/your-project/microservices-demo/adservice:v0.10.4 ghcr.io/your-github-username/microservices-demo/adservice:v0.10.4
```

Push the image:

```bash
  docker push ghcr.io/your-github-username/microservices-demo/adservice:v0.10.4 
```
</details>
...
```
oci://ghcr.io/your-github-username/charts/onlineboutique
```
...
```bash
helm push onlineboutique-0.10.4.tgz oci://ghcr.io/your-github-username
```
...
```bash
helm install boutique oci://ghcr.io/your-github-username/onlineboutique --version 0.10.4
```
</details>
