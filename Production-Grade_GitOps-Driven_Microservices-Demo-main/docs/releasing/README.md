...
1. Choose the logical [next release tag](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/releases), using [semantic versioning](https://semver.org/): `vX.Y.Z`.
...
export REPO_PREFIX=us-central1-docker.pkg.dev/your-project/microservices-demo # This is the Docker repository for tagged images
export PROJECT_ID=your-project # This is the Google Cloud project for the release CI
...
You can then browse the [Container Registry repository](https://console.cloud.google.com/gcr/images/your-project/global/microservices-demo?project=your-project) to make sure a Docker image was created for each microservice (with the new version tag).

## Create the PR

Now that the release branch has been created, you can find it in the [list of branches](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/branches) and create a pull request targeting `main` (the default branch).
...
Once the PR has been fully merged, you are ready to create a new release for the newly created [tag](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/tags).
- Click the breadcrumbs on the row of the latest tag that was created in the [tags](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/tags) page
- Select the `Create release` option

The release notes should contain a brief description of the changes since the previous release (like bug fixed and new features). For inspiration, you can look at the list of [releases](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/releases).
