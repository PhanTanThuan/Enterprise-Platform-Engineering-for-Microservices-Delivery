...
By default, the Online Boutique apps are targeting the latest release version (see the list of versions [here](https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/releases)). You may need to change this image tag to target a specific version, this Kustomize variation will help you setting this up.
