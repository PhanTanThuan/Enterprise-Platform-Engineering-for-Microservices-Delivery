...
Refer to this example and tweak based on your new service's needs: https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/src/frontend/Dockerfile
...
Refer to this example and tweak based on your new service's needs: https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/tree/main/kustomize/components/shopping-assistant
...
The file is available here: https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/kustomize/kustomization.yaml

## 6. Update the root `skaffold.yaml`

Add your newly created service to the root skaffold file so the images build correctly.

The file is available here: https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/blob/main/skaffold.yaml

## 7. Update the Helm chart

Add your newly created service to the Helm chart templates and default values.

The chart is available here: https://github.com/your-github-username/Production-Grade_GitOps-Driven_Microservices-Demo/tree/main/helm-chart
